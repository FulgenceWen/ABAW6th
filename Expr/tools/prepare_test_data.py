...
if __name__ == '__main__':
    ...
    root_video_path = "/data/zhangfengyu/ABAW/data/Aff-Wild2/raw/batch_1_2"
    # dataset_path = '/home/phankimngan/Projects/Affwild2-ABAW3-main/'
    dataset_path = '/data/zhangfengyu/ABAW/data/Aff-Wild2'
    ...
    for chal in [ 'EXPR',]: #'AU', 'VA',
        with open('{}/testset/{}_test_set_release.txt'.format(dataset_path, chal), 'r') as fd:
            ...
            np.save('{}/{}_test_set.npy'.format(dataset_path, chal), chal_test_dataset)
