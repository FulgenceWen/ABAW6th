...
DATA_DIR = {
    ...
    'ABAW':'/data/wenzhuofan/Data/ABAW/Split_Feature_Label',
...
PATH_TO_RAW_AUDIO = {
    ...
    'ABAW': '/data/wenzhuofan/Data/ABAW/Aff-Wild2/raw/Raw_audio/16k',
}
PATH_TO_RAW_VIDEO = {
...
PATH_TO_RAW_FACE = {
    ...
    'ABAW': '/data/wenzhuofan/Data/ABAW/Aff-Wild2/cropped-aligned/CA_all',
}
PATH_TO_TRANSCRIPTIONS = {
    ...
    'ODYSSEY': '/data/emotion-data/Odyseey_labels/transcription.csv',
}
PATH_TO_FEATURES = {
    ...
    'ABAW': os.path.join(DATA_DIR['ABAW'], 'split_feature'),
    'ODYSSEY': os.path.join(DATA_DIR['ODYSSEY'], 'features'),
}
PATH_TO_LABEL = {
    ...
    'ABAW': os.path.join(DATA_DIR['ABAW'],'split_label','label_0374_pesudo.npz'),
    'ODYSSEY': '/data/emotion-data/Odyseey_labels/label.npz',
}

# pre-trained models, including supervised and unsupervised
PATH_TO_PRETRAINED_MODELS = '/data/wenzhuofan/Data/ABAW/tools'
