...
class MFN(nn.Module):
    def __init__(self, args):
        ...
        self.fc_out_0 = nn.LSTM(output_dim, output_dim, 1, batch_first=True, bidirectional=True)
        self.fc_out_2 = nn.Linear(output_dim * 2, output_dim2)
    ...
    def forward(self, batch):
        ...
        '''
        self.fc_out_0.flatten_parameters()
        ...
        for i in range(t):
            ...
            feature=self.out_fc2(self.out_dropout(F.relu(self.out_fc1(hs))))
        ...
        features, _ = self.fc_out_0(features)
